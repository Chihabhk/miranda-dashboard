...
import { bookingCall, bookingDelete } from "../../features/bookingsSlice";
            ...
            <BookingContainer>
                <DataContainer>
                    ...
                    <InfoContainer>
                        ...
                        <RoomDescription>
                            {isLoading ? <></> : booking?.description}
                        </RoomDescription>
                        <RoomFacilities>
                            <p>Facilities</p>
                            {booking.amenities?.map((item, index) => {
                                return (
                                    <Facilitie key={index}>{item}</Facilitie>
                                );
                            })}
                        </RoomFacilities>
                    </InfoContainer>
